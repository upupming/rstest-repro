...
var bufLength = 16384;
var td = "u" > typeof TextDecoder ? /* @__PURE__ */ new TextDecoder() : void 0 !== Buffer ? {
    decode (buf) {
...
function getBtoa() {
    ...
    if ('function' == typeof magic_string_es_Buffer) return (str)=>magic_string_es_Buffer.from(str, 'utf-8').toString('base64');
    return ()=>{
