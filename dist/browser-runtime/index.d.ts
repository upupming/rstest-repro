...
import { MockInstance as MockInstance_2 } from '@vitest/spy';
...
export declare const createBrowserTaskContext: () => TaskContext;

export declare const createRstestRuntime: (workerState: WorkerState, { taskContext }: {
...
export declare type CurrentTaskInfo = Pick<UserConsoleLog, 'taskId' | 'taskName' | 'taskParentNames' | 'taskType' | 'testPath'>;
...
export declare const globalApis: readonly (keyof Rstest)[];
...
/** Per-platform task attribution primitive used by the shared runner. */ export declare interface TaskContext {
...
export declare const unwrapRegex: (value: string) => string | RegExp;
